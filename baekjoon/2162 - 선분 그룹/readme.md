lastupdated: 2017-08-20 10:00:01
...
| --- | --- | --- | --- | --- | --- |
| 2 초 | 128 MB | 1063 | 257 | 145 | 21.168% |
...
## 입력
첫째 줄에 N(1≤N≤3,000)이 주어진다. 둘째 줄부터 N+1번째 줄에는 양 끝점의 좌표가 x1, y1, x2, y2의 순서로 주어진다. 각 좌표의 절대값은 5,000을 넘지 않으며, 입력되는 좌표 사이에는 빈칸이 하나 이상 있다.
